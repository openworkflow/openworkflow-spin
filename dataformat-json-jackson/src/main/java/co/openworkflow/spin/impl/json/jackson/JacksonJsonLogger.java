...
import co.openworkflow.spin.json.SpinJsonPathException;
...
public class JacksonJsonLogger extends SpinLogger {
  ...
  public static final JacksonJsonLogger JSON_TREE_LOGGER = BaseLogger.createLogger(JacksonJsonLogger.class, PROJECT_CODE, "co.openworkflow.spin.json", "01");
