 ...
 */
package co.openworkflow.spin.impl.xml.dom.format;
...
public class DomXmlDataFormatWriterTest {
  ...
  // see https://github.com/camunda/camunda-bpm-platform/blob/master/engine-plugins/spin-plugin/src/main/java/co/openworkflow/spin/plugin/impl/SpinValueSerializer.java
  ...
  public void testCustomStripSpaceXSL() throws Exception {
    ...
    try (final InputStream inputStream = DomXmlDataFormatWriterTest.class.getClassLoader()
        .getResourceAsStream("co/openworkflow/spin/strip-space-preserve-space.xsl")) {
