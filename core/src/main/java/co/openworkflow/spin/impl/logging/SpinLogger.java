 ...
 */
package co.openworkflow.spin.impl.logging;
...
public abstract class SpinLogger extends BaseLogger {
  ...
  public static final SpinCoreLogger CORE_LOGGER = BaseLogger.createLogger(SpinCoreLogger.class, PROJECT_CODE, "co.openworkflow.spin", "01");
