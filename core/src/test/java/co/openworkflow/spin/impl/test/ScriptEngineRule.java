...
public class ScriptEngineRule implements TestRule {
  ...
  /**
   * Create script engine from {@literal @}{@link co.openworkflow.spin.impl.test.ScriptEngine} Annotation. The created
  ...
  private ScriptEngine createScriptEngine(Description description) {
    co.openworkflow.spin.impl.test.ScriptEngine annotation = description.getTestClass().getAnnotation(co.openworkflow.spin.impl.test.ScriptEngine.class);
    if (annotation == null) {
      return null;
    }
    else {
  ...
  /**
   * Get the script engine defined by the {@literal @}{@link co.openworkflow.spin.impl.test.ScriptEngine} Annotation
   *
